...
class StudentDetail:
    def __init__(self,root):
        ...
        #update photo btn
        updatePhoto_btn=Button(btn_frame1,command=self.update_photo_sample,text="Update photo Sample",width=57,font=("times new roman",13,"bold"),bg="blue",fg="white")
            ...
            try:
                ...
                while True:
                    ...
                    if cropped_face is not None:
                        ...
                        file_name_path = f"{output_dir}users.{str(student_id)}.{str(img_id)}.jpg"
